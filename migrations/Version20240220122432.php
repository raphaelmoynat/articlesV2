 ...
 */
final class Version20240220122432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "like" (id INT NOT NULL, author_id INT DEFAULT NULL, nem_id INT DEFAULT NULL, PRIMARY KEY(id))');
